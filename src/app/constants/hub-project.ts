...
export const timelineProjectData: ITimeline[] = [
    {
        ...
        subtitle: 'MARZO 2021',
        content:
            'Una vez finalizada la etapa de fondeo, la fiduciaria ordenará la compra de las unidades con un importante descuento respecto de similares departamentos en el edificio.',
    },
    {
    ...
    },
    {
        ...
        content:
            'Se estima que la obra termine entre octubre y marzo del 2024 momento en el cual estimamos que las unidades habrán alcanzado el mayor valor de venta del mt².',
    },
];
...
export const responsibleData = [
    {
        ...
        content:
            'Estudio que cuenta con más de 20 años de trayectoria y más de 80.000mts² de obra construidos de edificios en las mejores zonas de la ciudad de Buenos Aires.',
    },
    {
        ...
        content:
            'Se dedica a prestar servicios integrales respecto a proyectos y desarrollos inmobiliarios en general y se especializa en obras comerciales como por ejemplo la ampliación del Aeropuerto Jorge Newbery, el Solar de la Abadía y diversos cines para la cadena Village. También realizaron el Tortugas Open Mall y Madero Walk un conjunto de locales flotantes en el Dique 1 de Puerto Madero. Hoy cuentan con estudios en Buenos Aires y Santiago de Chile.',
    },
    {
        ...
        content:
            'Fundado en 1984 por los arquitectos Luis Camps y Ramiro Tiscornia, este estudio de arquitectura brinda un servicio integral para satisfacer a sus clientes tanto en el plano comercial como en lo técnico y funcional.',
    },
    {
        ...
        content:
            'Inmobiliaria con 27 años de trayectoria y más de 1,5 millones de m2 comercializados. Actualmente, cuenta con un equipo de 40 profesionales especializados en la comercialización de propiedades residenciales, locales y oficinas en Argentina y el exterior.',
    },
    {
