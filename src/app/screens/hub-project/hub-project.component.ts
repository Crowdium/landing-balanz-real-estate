...
import {
    ...
    timelineProjectData,
    urlVideo,
} from 'src/app/constants/hub-project';
...
export class HubProjectComponent implements OnInit {
    ...
    signIn: string =
        'https://clientes.balanz.com/?utm_source=landingcrowdium&utm_medium=cta&utm_campaign=hub-cabildo';
    signUp: string =
        'https://balanz.com/abrir-cuenta-2.aspx/?utm_source=landingcrowdium&utm_medium=cta&utm_campaign=hub-cabildo';
